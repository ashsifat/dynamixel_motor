...
if __name__ == '__main__':
    port_name_0='/dev/ttyUSB4'
    port_namespace_0='ttyUSB4'
    port_name_1='/dev/ttyUSB5'
    port_namespace_1='ttyUSB5'
    baud_rate=3000000
    min_motor_id=1
    max_motor_id=25
    update_rate=5
...
#		val=20*math.sin(3.1416*current_time)-20
		val=20*math.sin(3.1416*0.5*current_time)+20 	##right
		#val=-20
		val=int(round(val))
		write_data_whole= twos_complement(val, nbits)
		write_data_L=write_data_whole & 0xFF
		...
		######write to motor 2############
#		val=20*math.sin(3.1416*current_time)+20
		val=5*math.sin(3.1416*0.5*current_time)-15		##right
		#val=20
		val=int(round(val))
		write_data_whole= twos_complement(val, nbits)
		write_data_L=write_data_whole & 0xFF
...
#		val=5*math.sin(3.1416*current_time)+5		##right
#		#val=-5
#		val=int(round(val))
#		write_data_whole= twos_complement(val, nbits)
#		write_data_L=write_data_whole & 0xFF
...
#		val=20*math.sin(3.1416*current_time)-10
		val=10*math.sin(3.1416*0.5*current_time)+5		##right		
		#val=0
		val=int(round(val))
		write_data_whole= twos_complement(val, nbits)
		write_data_L=write_data_whole & 0xFF
		...
		################ left arm ###############################3
		val=20*math.sin(3.1416*0.5*current_time)-15
		#val=-20
		val=int(round(val))
		write_data_whole= twos_complement(val, nbits)
		write_data_L=write_data_whole & 0xFF
		...
		######write to motor 2############
		val=5*math.sin(3.1416*0.5*current_time)+15
		#val=20
		val=int(round(val))
		write_data_whole= twos_complement(val, nbits)
		write_data_L=write_data_whole & 0xFF
...
#		######write to motor 3############
		...
		print "write done, response:", write_response
##		########## write to motor 4 ##############
		val=10*math.sin(3.1416*0.5*current_time)-8
		#val=0
		val=int(round(val))
		write_data_whole= twos_complement(val, nbits)
		write_data_L=write_data_whole & 0xFF
