...
def posnew():
    ...
    rospy.init_node('posnew', anonymous=True)
...
#    val2_lhp=int(round(val-angles[0,3]))
    val1_lhp=int(round(val))
    val2_lhp=int(round(val))
...
#		write_data_H1 = (write_data_whole1>>8) & 0xFF
			...
			sync_write_data = [0x04, 0x00, 0x01, write_data_1,write_data_2,write_data_3,write_data_4, 0x02, write_data_1, write_data_2, write_data_3, write_data_4 ]
			dxl_io_1.sync_write(sync_write_address, sync_write_data)
